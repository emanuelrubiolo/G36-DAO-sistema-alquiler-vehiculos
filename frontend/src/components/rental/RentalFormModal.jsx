...
export default function RentalFormModal({
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Registrando alquiler:", dataToSubmit);
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[75vh] overflow-y-auto">
            ...
            <FormInput
              label="Fecha y Hora de Retiro (Ahora)"
              id="startDate"
              name="startDate"
              type="datetime-local"
            ...
            >
              ...
              <option value="ALQUILADO">Alquilado (Pendiente de retiro)</option>
            </FormSelect>
